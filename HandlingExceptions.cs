...
namespace ExceptionHandling
{
    public static class HandlingExceptions
    {
        ...
        {
            // TO DO #1. Add a try-catch construction here to catch all exceptions. The method should return true if an exception is thrown; otherwise false.
            try
            {
                ThrowException(obj);
            }
        ...
        public static bool CatchArgumentNullException(object obj, out string exceptionMessage)
        {
            ...
            // TO DO #2. Add a try-catch construction here to catch "ArgumentNullException". The method should return true if an "ArgumentNullException" is thrown and set "exceptionMessage" parameter to an exception message; otherwise the method should return false.
            try
            {
                ThrowException(obj);
            }
        ...
        public static bool CatchArgumentException(int i, out string exceptionMessage)
        {
            ...
            // TO DO #3. Add a try-catch construction here to catch "ArgumentException". The method should return true if an "ArgumentException" is thrown and set "exceptionMessage" parameter to an exception message; otherwise the method should return false.
            try
            {
        ...
        public static bool CatchArgumentOutOfRangeException(int j, out string exceptionMessage)
        {
            ...
            // TO DO #4. Add a try-catch construction here to catch "ArgumentOutOfRangeException". The method should return true if an "ArgumentOutOfRangeException" is thrown and set "exceptionMessage" parameter to an exception message; otherwise the method should return false.
            try
            {
        ...
        public static bool CatchExceptions(object obj, int i, int j, bool throwException, out string exceptionMessage)
        {
            ...
            // TO DO #5. Add a try-catch construction here to catch exceptions with these types:
            // * Exception
            // * ArgumentException
